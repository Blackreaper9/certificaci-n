"use strict";
(self.webpackChunksecuritynetwork_recordvoice = self.webpackChunksecuritynetwork_recordvoice || []).push([[453], { 453: (e, t, n) => { n.r(t), n.d(t, { getCLS: () => y, getFCP: () => g, getFID: () => F, getLCP: () => P, getTTFB: () => D }); var i, r, a, o, c = function (e, t) { return { name: e, value: void 0 === t ? -1 : t, delta: 0, entries: [], id: "v2-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1e12) }; }, u = function (e, t) { try {
        ...
        } }, d = u("layout-shift", v); d && (n = m(i, r, t), s((function () { d.takeRecords().map(v), n(!0); })), f((function () { a = 0, T = -1, r = c("CLS", 0), n = m(i, r, t); }))); }, E = { passive: !0, capture: !0 }, w = new Date, L = function (e, t) { i || (i = t, r = e, a = new Date, k(removeEventListener), S()); }, S = function () { if (r >= 0 && r < a - w) {
        ...
        } }, k = function (e) { ["mousedown", "keydown", "touchstart", "pointerdown"].forEach((function (t) { return e(t, b, E); })); }, F = function (e, t) { var n, a = l(), v = c("FID"), d = function (e) { e.startTime < a.firstHiddenTime && (v.value = e.processingStart - e.startTime, v.entries.push(e), n(!0)); }, p = u("first-input", d); n = m(e, v, t), p && s((function () { p.takeRecords().map(d), p.disconnect(); }), !0), p && f((function () { var a; v = c("FID"), n = m(e, v, t), o = [], r = -1, i = null, k(addEventListener), a = d, o.push(a), S(); })); }, C = {}, P = function (e, t) { var n, i = l(), r = c("LCP"), a = function (e) { var t = e.startTime; t < i.firstHiddenTime && (r.value = t, r.entries.push(e), n()); }, o = u("largest-contentful-paint", a); if (o) {
            n = m(e, r, t);
            var v = function () { C[r.id] || (o.takeRecords().map(a), o.disconnect(), C[r.id] = !0, n(!0)); };
            ["keydown", "click"].forEach((function (e) { addEventListener(e, v, { once: !0, capture: !0 }); })), s(v, !0), f((function (i) { r = c("LCP"), n = m(e, r, t), requestAnimationFrame((function () { requestAnimationFrame((function () { r.value = performance.now() - i.timeStamp, C[r.id] = !0, n(!0); })); })); }));
        } }, D = function (e) { var t, n = c("TTFB"); t = function () { try {
